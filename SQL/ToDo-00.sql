...
-- Tables
IF EXISTS(SELECT * FROM sys.tables WHERE name='ToDo')
	DROP TABLE ToDo
GO
...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES
   WHERE ROUTINE_NAME = 'ToDoSelectAll')
      DROP PROCEDURE ToDoSelectAll
GO

CREATE PROCEDURE ToDoSelectAll
AS
...
IF EXISTS(SELECT * FROM INFORMATION_SCHEMA.ROUTINES
   WHERE ROUTINE_NAME = 'ToDoSelectById')
      DROP PROCEDURE ToDoSelectById
GO

CREATE PROCEDURE ToDoSelectById (
	@Id int
)
AS
	SELECT *
